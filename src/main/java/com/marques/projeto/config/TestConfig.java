...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Pedido p1 = new Pedido(null, Instant.parse("2023-07-20T19:02:20Z"),u1);
        Pedido p2 = new Pedido(null, Instant.parse("2023-05-10T15:08:20Z"),u2);
        Pedido p3 = new Pedido(null, Instant.parse("2022-11-30T21:02:20Z"),u1);
